    ...
    >
      <div className="max-w-[1440px] mx-auto px-4 sm:px-8 lg:px-12">
        ...
        <div className="mb-14">
          ...
          >
            <span className="font-mono text-xs text-[#D4A017] font-bold tracking-widest uppercase">
              COMPETÊNCIAS
            </span>
            <div className="w-12 h-[1px] bg-[#D4A017]/50" />
          </motion.div>
            ...
            {competencies.map((item, idx) => {
              ...
              return (
                <motion.div
                  ...
                  className="interactive-card bg-[#121519] border border-[rgba(255,255,255,0.08)] hover:border-[#D4A017] p-5 flex flex-col justify-between group"
                >
                  <div>
                    ...
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <div className="w-9 h-9 rounded-full border border-[#D4A017]/60 bg-[#161A20] flex items-center justify-center text-[#D4A017] group-hover:border-[#D4A017] group-hover:scale-105 transition-transform duration-300 ease-[cubic-bezier(0.22,1,0.36,1)]">
                        <IconComp className="w-4 h-4" />
                      </div>
                    </div>

                    {/* Title */}
                    <h3 className="font-condensed text-lg sm:text-xl font-bold uppercase tracking-tight text-[#F5F7FA] mb-2 group-hover:text-[#D4A017] transition-colors duration-300">
                      {item.title}
                    </h3>
                  ...
                  <div className="pt-6 mt-4 border-t border-[rgba(255,255,255,0.06)] flex items-center justify-between">
                    <div className="w-8 h-[2px] bg-[#D4A017] opacity-70 group-hover:w-12 transition-all duration-300 ease-[cubic-bezier(0.22,1,0.36,1)]" />
                    <span className="font-mono text-xs text-[#D4A017]">+</span>
                  </div>
                </motion.div>
              );
            })}
        ...
        <div className="mb-12">
          ...
          >
            ...
            <span className="font-mono text-[10px] text-[#7C8793] tracking-widest uppercase">
            ...
            {primaryTools.map((tool, idx) => {
              ...
              return (
                <motion.a
                  ...
                  className="interactive-card bg-[#121519] border border-[rgba(255,255,255,0.08)] hover:border-[#D4A017] p-5 sm:p-6 flex items-start gap-4 group cursor-pointer"
                >
                  <div className="w-12 h-12 rounded bg-[#161A20] border border-[rgba(255,255,255,0.10)] flex items-center justify-center text-[#D4A017] flex-shrink-0 group-hover:border-[#D4A017] transition-colors duration-300">
                    <ToolIcon className="w-6 h-6" />
                  </div>

                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between gap-2 mb-1">
                      <h4 className="font-condensed text-lg sm:text-xl font-bold uppercase tracking-tight text-[#F5F7FA] group-hover:text-[#D4A017] transition-colors duration-300 truncate">
                        {tool.name}
                      </h4>
                      <span className="interactive-arrow text-sm font-sans text-[#7C8793] group-hover:text-[#D4A017]">↗</span>
                    </div>
                    <p className="text-xs text-[#B0B5BB] leading-relaxed font-body">
                      {tool.description}
                    </p>
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true, margin: '-40px' }}
          transition={{ duration: 0.65, delay: 0.15, ease: EASE_SMOOTH }}
          className="p-4 sm:p-5 bg-[#121519] border border-[rgba(255,255,255,0.08)] flex flex-col sm:flex-row items-center justify-between gap-4"
        >
          <div className="flex items-center gap-3">
            <span className="font-mono text-xl text-[#D4A017] font-bold">“</span>
            <p className="text-xs sm:text-sm text-[#F5F7FA] font-body">
              Ferramentas são importantes, mas é a disciplina e a curiosidade que constroem resultados.
            </p>
          </div>

          <div className="flex items-center gap-3 font-mono text-[10px] text-[#7C8793] tracking-widest uppercase flex-shrink-0">
